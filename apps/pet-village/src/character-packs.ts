...
export function isSystemPet(id: CharacterId): boolean {
  return Object.prototype.hasOwnProperty.call(CHARACTER_BEHAVIOR_PACKS, id);
}

export function bundledBehaviorPackForCharacter(id: CharacterId): CompiledBehaviorPack {
