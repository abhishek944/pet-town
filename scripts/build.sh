...
Darwin:arm64)
  "$ROOT/scripts/prepare-pi-runtime.sh" macos-arm64
  runtime_archive="$ROOT/bin/macos-arm64/pet-village-pi-runtime.tar.gz"
  ;;
Darwin:x86_64)
  "$ROOT/scripts/prepare-pi-runtime.sh" macos-x64
  runtime_archive="$ROOT/bin/macos-x64/pet-village-pi-runtime.tar.gz"
  ;;
esac
