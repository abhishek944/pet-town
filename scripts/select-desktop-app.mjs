...
const app = process.env.PET_TOWN_APP ?? "v1";
if (app !== "v1" && app !== "v2") {
  console.error(`PET_TOWN_APP must be v1 or v2, received: ${app}`);
  process.exit(2);
}
const command = process.argv[2] ?? "dev";
const extra = process.argv.slice(3);
const packageName = app === "v2" ? "@pet-town/desktop-v2" : "@pet-town/desktop";
...
console.log(`Pet Town desktop selection: ${app} (${packageName})`);
